...
class Deck
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\User", inversedBy="decks")
     */
    private $user;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\DeckCard", mappedBy="deck")
     */
    private $deckCards;
